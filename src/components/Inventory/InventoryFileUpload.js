...
import InvetoryFile from"./InventoryFile";
...
function InventoryFileUpload() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      await axios.post("http://localhost:5000/infile/upload", formData);
  ...
  useEffect(() => {
    axios.get("http://localhost:5000/infile/files") // Replace with your backend API URL
      .then((response) => {
  ...
  return (
    <div className='container'>
      ...
      <br/>
      <br/>
      <p><b>UPLOAD WEEKLY REPORTS IN DATABASE</b></p>
    <div className="uploader-body"> 
      ...
      <br/>
      <br/>
      <h5 style={{marginLeft:"50px"}}><b> CHECK PAST RECORD ABOUT MATERIAL USAGE</b></h5>
      <br/>
      <ul>
        {files.map((file) => (
          <li key={file._id}>
